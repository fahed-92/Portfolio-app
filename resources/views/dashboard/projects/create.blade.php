        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">{{ __('messages.add Setting') }}</li>
                </ol>
            </div>
...
<!-- Content Row -->
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">{{ __('messages.Site Project') }}</h4>
                    <p class="card-title-desc">{{ __('messages.add Project') }}</p>
                    <form class="form row"  method="POST" enctype="multipart/form-data" action="{{ route('admin.projects.store') }}">
{{--                         @method('POST')--}}
